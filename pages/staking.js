  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Comparez les meilleurs taux de staking sur ETH, SOL et BTC. Bientôt sur Nantix." />
      </Head>
      <Navbar />
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px' }}>
          <div style={{ maxWidth: '420px', width: '100%', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '14px', color: '#888', lineHeight: '1.6', marginBottom: '36px' }}>
              ETH, SOL, BTC — liquid staking, CeFi et DeFi comparés.
            </p>

            <div style={{ background: '#FAFAFA', border: '1px solid #EBEBEB', borderRadius: '12px', padding: '20px 24px', marginBottom: '32px', textAlign: 'left' }}>
              {[
                { icon: '⚡', t: 'Liquid staking ETH', d: 'Lido, Rocket Pool, EigenLayer' },
                { icon: '🌊', t: 'Staking SOL', d: 'Jito, Marinade, validators natifs' },
                { icon: '🔗', t: 'Filtre par type', d: 'Liquid / CeFi / DeFi' },
              ].map(item => (
