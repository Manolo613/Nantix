...
const PLATFORMS = {
  usdc: {
    ...
    ethereum: [
      ...
      { name: 'Nebeus',    apr: 7.0,   ltv: 70,  liq: 80,   type: 'CeFi', color: '#6C3CE1', link: 'https://nebeus.com',       best: false, founded: '2014', country: 'Royaume-Uni',    users: '200K+', regulated: true,  manualUpdate: 'avr. 2026', about: 'Prêt ETH sur Nebeus. Interest Only Loan (7% APR, LTV 65%) ou Flexible Loan (16.5%, LTV 70%). FCA-régulée.' },
    ],
  },
  usdt: {
    bitcoin: [
    ...
    ethereum: [
      ...
      { name: 'Nebeus',    apr: 7.0,   ltv: 65,  liq: 80,   type: 'CeFi', color: '#6C3CE1', link: 'https://nebeus.com',       best: false, founded: '2014', country: 'Royaume-Uni',    users: '200K+', regulated: true,  manualUpdate: 'avr. 2026', about: 'Prêt ETH sur Nebeus. Interest Only Loan (7% / an, LTV 65%) ou Flexible Loan (16.5%, LTV 70%). FCA-régulée.' },
    ],
  },
}
