      ...
      <main style={{ background: '#F7F7F5', minHeight: '100vh', paddingTop: '56px' }}>
        ...
        <section style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
            {['5 plateformes', 'Gratuit · Sans inscription'].map(t => (
              <div key={t} style={{
        ...
        <section style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div style={{
              ...
              />
              <span style={{ padding: '0 10px', fontWeight: '600', color: '#CCC', fontSize: '13px' }}>
                {crypto.symbol}
              </span>
            </div>
          ...
          <div style={{ display: 'flex', gap: '10px', marginLeft: 'auto' }}>
            <div style={{
              ...
              borderRadius: '8px', border: '1px solid #E0E0E0', overflow: 'hidden',
            }}>
              {['all', 'CeFi', 'DeFi'].map(f => (
        ...
        <section style={{ padding: '24px 40px 40px', background: '#F7F7F5' }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={step.n} style={{
                ...
                <span style={{
                  fontSize: '24px', fontWeight: '700', color: '#EBEBEB',
                  lineHeight: '1', flexShrink: 0, letterSpacing: '-1px',
                }}>{step.n}</span>
                <div>
          ...
          <div style={{
            display: 'grid',
            gridTemplateColumns: '175px 1fr 1fr 1fr 1fr 120px',
