...
const PLATFORMS = {
  usdc: {
    bitcoin: [
      ...
      { name: 'YouHodler', apr: 8.0,   ltv: 90, liq: 95,  type: 'CeFi', color: '#1EBDD2', link: 'https://youhodler.com',    best: false, founded: '2018', country: 'Suisse / Chypre',  users: '1M+',   regulated: true,  manualUpdate: 'avr. 2026', about: 'Plateforme CeFi suisse. 8% APR, LTV jusqu\'à 90% sur BTC. Margin call à 84% LTV, liquidation à 95%. Prêts en USDC/USDT.' },
    ...
    ethereum: [
      ...
      { name: 'YouHodler', apr: 8.0,   ltv: 90,  liq: 95,   type: 'CeFi', color: '#1EBDD2', link: 'https://youhodler.com',    best: false, founded: '2018', country: 'Suisse / Chypre', users: '1M+',   regulated: true,  manualUpdate: 'avr. 2026', about: 'Prêts en USDC/USDT adossés à ETH. 8% APR, LTV jusqu\'à 90%, liquidation à 95% LTV.' },
  ...
  usdt: {
    bitcoin: [
      ...
      { name: 'YouHodler', apr: 8.0,   ltv: 90, liq: 95,   type: 'CeFi', color: '#1EBDD2', link: 'https://youhodler.com',    best: false, founded: '2018', country: 'Suisse / Chypre', users: '1M+',   regulated: true,  manualUpdate: 'avr. 2026', about: 'Prêts en USDT adossés à BTC. 8% APR, LTV jusqu\'à 90%, liquidation à 95% LTV.' },
      { name: 'Nexo',      apr: 13.9,  ltv: 50, liq: 83,   type: 'CeFi', color: '#0EA5E9', link: 'https://nexo.com',         best: false, founded: '2018', country: 'UE / Caïmans',   users: '7M+',   regulated: true,  manualUpdate: 'avr. 2026', aprLabel: '6.9 – 13.9', about: 'Plateforme CeFi régulée, 7M+ utilisateurs. Taux selon niveau fidélité NEXO token.' },
      { name: 'Nebeus',    apr: 6.0,   ltv: 65, liq: 75,   type: 'CeFi', color: '#6C3CE1', link: 'https://nebeus.com',       best: false, founded: '2014', country: 'Royaume-Uni',    users: '200K+', regulated: true,  manualUpdate: 'avr. 2026', aprLabel: '6 – 16.5', about: 'Prêt BTC sur Nebeus. Interest Only Loan (6% APR, LTV 65%) ou Flexible Loan (16.5%, LTV 70%). FCA-régulée.' },
    ],
    ethereum: [
      ...
      { name: 'Compound',  apr: 4.5,   ltv: 75,  liq: 80,   type: 'DeFi', color: '#00D395', link: 'https://compound.finance', best: false, founded: '2018', country: 'Décentralisé',    users: '200K+', regulated: false, manualUpdate: 'avr. 2026', about: 'Protocole DeFi pionnier. Gouvernance décentralisée COMP. Taux variables.' },
      { name: 'YouHodler', apr: 8.0,   ltv: 90,  liq: 95,   type: 'CeFi', color: '#1EBDD2', link: 'https://youhodler.com',    best: false, founded: '2018', country: 'Suisse / Chypre', users: '1M+',   regulated: true,  manualUpdate: 'avr. 2026', about: 'Prêts en USDT adossés à ETH. 8% APR, LTV jusqu\'à 90%, liquidation à 95% LTV.' },
