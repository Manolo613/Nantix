...
export default function Comparateur() {
  ...
  // Lecture des paramètres URL venant de la page d'accueil
  useEffect(() => {
    if (!router.isReady) return
    const { crypto, amount: urlAmount } = router.query
    if (crypto && CRYPTOS.find(c => c.id === crypto)) {
  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '64px' }}>
        ...
        {/* Header */}
        <section style={{ background: 'var(--cream)', padding: '60px 60px 32px' }}>
        ...
        {/* Crypto selector */}
        <section style={{ background: 'var(--cream)', padding: '0 60px 32px' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {/* Table */}
        <section style={{ background: 'var(--cream)', padding: '40px 60px' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            {filtered.length === 0 ? (
              ...
              <>
                ...
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: '240px 1fr 1fr 1fr 1fr 180px',
                  gap: '24px',
                  padding: '14px 32px',
                  fontSize: '12px',
                  fontWeight: '600',
        ...
        {/* Info bloc */}
        <section style={{ background: 'var(--cream-dark)', padding: '32px 60px', borderTop: '1px solid var(--cream-border)' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', gap: '40px', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
